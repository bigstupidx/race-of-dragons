...
public class PickupItemBox : Photon.MonoBehaviour, IPunObservable
{
    ...
    /// are being re-set.
    /// </remarks>
    public float SecondsBeforeRespawn = 1;
    ...
    internal void PickedUp(float timeUntilRespawn)
    {
        ...
        PickupItemBox.DisabledPickupItems.Add(this);
    ...
    internal void PunRespawn()
    {
        ...
        PickupItemBox.DisabledPickupItems.Remove(this);
        this.TimeOfRespawn = 0;
